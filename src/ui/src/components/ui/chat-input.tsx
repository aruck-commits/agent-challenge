  ...
  return (
    <ChatInputContext.Provider value={contextValue}>
      <div
        className={cn(
          variant === 'default' &&
            'flex w-full flex-col items-end rounded-2xl border border-white/15 bg-black/20 p-2 focus-within:outline-none focus-within:ring-1 focus-within:ring-[#00ff7f]/50',
  ...
  if (loading && onStop) {
    return (
      <Button
        ...
        variant="outline"
        className={cn(
          'h-fit shrink-0 rounded-full p-1.5',
          className,
        )}
        {...props}
      >
